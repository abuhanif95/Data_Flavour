...
const colorMap = {
  blue: {
    ...
    dot: "bg-blue-700",
    btn: "text-blue-700 border-blue-700 bg-blue-50",
  },
  purple: {
    bar: "bg-purple-700",
    ...
    dot: "bg-purple-700",
    btn: "text-purple-700 border-purple-700 bg-purple-50",
  },
};
        ...
        {members.map((m) => {
          ...
          return (
            ...
            >
              ...
              {/* Badge */}
              <span
                className={`absolute top-4 right-4 text-xs font-medium px-3 py-1 rounded-full ${c.badge}`}
              >
                Developer
              </span>
              ...
              <div className="flex justify-center pt-6 pb-3 bg-gray-50">
                <div
                  className={`p-0.5 rounded-full bg-gradient-to-br ${c.ring}`}
                >
                  <div
                    className={`w-20 h-20 rounded-full flex items-center justify-center text-2xl font-medium border-2 border-white ${c.avatar}`}
                  >
                    {m.initials}
                  </div>
                </div>
              ...
              <div className="px-5 pb-5 pt-3 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-1.5 mb-4">
                  {m.modules.map((mod) => (
                    <span
                      key={mod}
                      className="text-xs px-2.5 py-1 rounded-md border border-gray-100 text-gray-500 bg-gray-50"
                    >
                      {mod}
                    </span>
                  ))}
                ...
                <a
                  href="#"
                  className={`inline-flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-medium border transition-opacity hover:opacity-80 ${c.btn}`}
                >
